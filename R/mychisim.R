...
#'
#' @examples
mychisim = function(n1=10,sigma1=3,mean1=5,iter=1000,ymax=0.1,yleg=10,xleg=10,...){    # adjust ymax to make graph fit
  ...
  legend(xleg, yleg,c("Simulated","Theoretical"),col=c("Blue","Red"),lwd=4,lty=1:2,bty="n",title=title) # Legend #
